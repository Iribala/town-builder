...
Kukicha is a near-superset of Go that adds pipes, `onerr`, enums, if-expressions, and readable operators on top of standard Go syntax. This project is a Kukicha project — compile and run `.kuki` files with the `kukicha` compiler (v0.85.1).
